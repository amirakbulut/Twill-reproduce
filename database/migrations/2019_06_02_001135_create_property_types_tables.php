...
class CreatePropertyTypesTables extends Migration
{
    public function up()
    {
        ...
        Schema::create('property_type_translations', function (Blueprint $table) {
            createDefaultTranslationsTableFields($table, 'property_type');
        ...
        Schema::create('property_type_slugs', function (Blueprint $table) {
            createDefaultSlugsTableFields($table, 'property_type');
        });

        // remove this if you're not going to use revisions, ie. using the HasRevisions trait
        Schema::create('property_type_revisions', function (Blueprint $table) {
            createDefaultRevisionsTableFields($table, 'property_type');
        });
    }

    public function down()
    {
        Schema::dropIfExists('property_type_revisions');
        Schema::dropIfExists('property_type_translations');
        Schema::dropIfExists('property_type_slugs');
